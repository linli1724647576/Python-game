...
class Trivia(object):
    ...
    def show_question(self):
        if(self.end==0):
            ...
            print_text(font2,400,500-20,"Press Keys (1-4) To Answer",purple)
            ...
            if self.scored:
                ...
                print_text(font1,600-170,380,"CORRECT!",green)
                print_text(font2,600-220,420,"Press Enter For Next Question",green)
            elif self.failed:
                self.colors=[white,white,white,white]
                self.colors[self.wronganswer-1]=red
                self.colors[self.correct-1]=green
                print_text(font1,600-170,380,"INCORRECT",red)
                print_text(font2,600-220,420,"Press Enter For Next Question",red)
